...
Este paquete documenta el diseño físico y lógico de red para la XXV Olimpiada
Mexicana de Informatica (OMI) en Tec de Monterrey Campus Chihuahua.

Antes de modificar el diseño, leer `docs/README.md` y los documentos base.

## Reglas

- Escribir en español y mantener Markdown claro.
...
- No afirmar que una configuración esta implementada hasta validarla en el `.pkt`.
...
validados; faltan las capturas y la integración del reporte final.
